        ...
        <div className="flex flex-col border-b-2 border-bgGreen ml-12 justify-between w-64 py-10 px-5 fixed mt-8">
            <div>
                ...
                <div className="flex flex-col ">
                    <SidebarMenu title="Salas" icon="people-group" buttons={['Criar salas', 'Editar salas']} urls={['/group/create', '/groups']}/>
                    ...
                    <SidebarMenu title="Noticias" icon="newspaper" buttons={['Resultados por salas', 'Resultados por estratégia']} urls={['/results/room', '/results/strategy']}/>
                    ...
                    <SidebarMenu title="Catalogador" protected icon="envelope" buttons={[]} urls={[]}/>
                    <br />
